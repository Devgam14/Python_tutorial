...
query = connection.My_Table.ALL
rows = connection(query).select(orderby = ~connection.My_Table.Age)

for row in rows :
    print("{} {} {} {} {} {} {} {}".format(row["id"] , row["Names"] , row["Age"] , row["DOB"] , row["Gender"] , row["Salary"] , row["Email"] , row["Phone"]))                       